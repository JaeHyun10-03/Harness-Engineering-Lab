...
- 모호한 요청은 질문으로 구체화하고, 미결정 사항이 남은 채 구현하지 않도록 합니다.
...
작업 상태·검사 증거·완료 판정은 공통 핵심으로 유지합니다. 실제 프로젝트의 도메인 정책, 코드·테스트 규칙, 이슈·PR 절차, 성능 측정, CI·배포 조건은 프로젝트 전용 계층으로 연결합니다. 이슈에는 목표와 이유를, 하네스 작업에는 진행·검증 기록을, PR에는 변경 내용과 팀 리뷰를 둡니다. 자세한 결정과 이식 완료 조건은 [결정 기록](docs/decisions.md)에 있습니다.
